...
import { sessionSchema, type Cookies, type PartialUser, type SessionPayload } from "@/auth/nextjs/schemas";

// Seven days in seconds
export const SESSION_EXPIRATION_SECONDS = 60 * 60 * 24 * 7;
export const COOKIE_SESSION_KEY = "_Gateling_Dresses_SESSION_KEY";
