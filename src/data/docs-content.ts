...
export const docsArticles: DocArticle[] = [
	...
	},
	{
		...
		actions: [{ label: "Trigger a password reset", href: "/forgot-password" }],
	},
	{
		id: "passkeys",
		...
		actions: [{ label: "Open the security settings", href: "/app" }],
	},
	{
	...
	},
	{
		...
		summary:
			"Short-lived, HMAC-signed HTTP-only cookies keep accounts secure without server-side session state.",
		category: "Platform",
		tags: ["sessions", "cookies", "rotation"],
		body: [
			"Every login issues an HMAC-signed JWT stored in an HTTP-only cookie; no database lookups are required for reads.",
			"Tokens expire after a week by default and can be refreshed by reissuing the cookie after critical actions.",
			"Session listing and revocation are disabled because the cookie is the single source of truth.",
		],
		actions: [{ label: "View session policy", href: "/app/sessions" }],
	},
	{
		id: "organizations",
	...
	},
	{
		...
		actions: [{ label: "Explore pricing", href: "/pricing" }],
	},
	{
		id: "email",
		...
		actions: [{ label: "Preview email templates", href: "/auth/nextjs/emails" }],
	},
];
