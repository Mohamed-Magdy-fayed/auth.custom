                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    placeholder={authMessage("profile.displayName.placeholder", "Your name")}
                                    {...field}
                                />
                            </FormControl>
                            <FormMessage />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        placeholder={authMessage("profile.givenName.placeholder", "First name")}
                                        {...field}
                                    />
                                </FormControl>
                                <FormMessage />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        placeholder={authMessage("profile.familyName.placeholder", "Last name")}
                                        {...field}
                                    />
                                </FormControl>
                                <FormMessage />
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>
                                    {authMessage("profile.locale.label", "Locale")}
                                </FormLabel>
                                <FormControl>
                                    <Input
