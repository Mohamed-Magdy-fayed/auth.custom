import { OWNER_ROLE_KEY, type PermissionKey, permissionDefinitions } from "./permissions"
...
const allPermissionKeys = permissionDefinitions.map(definition => definition.key)
