		...
		<MarketingLayout>
			<section className="bg-muted/30">
				<div className="container space-y-6 py-20 text-center">
					...
					<H1 className="text-4xl sm:text-5xl">
						Everything a modern SaaS needs to run auth
					</H1>
					<Muted className="mx-auto max-w-3xl text-lg">
						Gateling Auth is more than login. It is a complete user lifecycle with
						security best practices, multi-tenant management, billing, and
						documentation — ready for production on day one.
					</Muted>
			...
			<section className="container space-y-12 py-20">
				{CORE_FEATURES.map((feature) => (
					<div
						key={feature.title}
						className="grid gap-6 rounded-3xl border bg-background p-8 shadow-sm md:grid-cols-[0.4fr_1fr] md:items-start"
					>
			...
			<section className="bg-muted/20">
				<div className="container grid gap-8 py-20 md:grid-cols-2">
					<div className="space-y-4">
						...
						<Muted>
							Bring your favorite database, transport, or UI toolkit. Gateling Auth
							handles the plumbing so you can focus on customer-facing work.
						</Muted>
					</div>
