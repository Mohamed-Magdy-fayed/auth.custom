				...
				<div className="container grid gap-10 lg:grid-cols-[2fr_1fr]">
					<div className="space-y-6 text-left">
						...
						<ol className="space-y-4 text-sm text-muted-foreground">
							<li>
								<p className="font-semibold text-foreground">1. Copy the auth module</p>
								<p>
							...
							<li>
								...
								<p>
									Mirror the keys defined in{" "}
									<InlineCode>src/data/env/server.ts</InlineCode>
									inside your own <InlineCode>.env.local</InlineCode>. The helper exports
									a single <InlineCode>env</InlineCode> object so you can read
									configuration from anywhere in your app.
								</p>
							</li>
							<li>
								<p className="font-semibold text-foreground">
								...
								<p>
									Re-export the provided middleware so protected routes, API handlers,
									and OAuth callbacks work immediately.
								</p>
...
pnpm drizzle-kit push`}</code>
						...
						<Muted>
							...
							<InlineCode>@/auth</InlineCode> without copying UI components — the
							folder is designed as a drop-in module.
						</Muted>
					</div>
						...
						<ul className="space-y-3">
							<li>
								<p>
									...
									The workspace shell, user menu, and settings dialogs are already wired
									to the session context.
								</p>
							</li>
							<li>
								<p>
									<span className="font-semibold text-foreground">Feature toggles.</span>{" "}
									Flip switches in <InlineCode>auth/config/features.ts</InlineCode> to
									enable passkeys, password policies, or OAuth providers.
								</p>
							</li>
							<li>
								<p>
									...
									Server actions, token issuance, and React Email previews live in the
									same directory for quick edits.
								</p>
							</li>
							<li>
								<p>
									...
									Drizzle schemas and query helpers are preconfigured so you can extend
									them without touching raw SQL.
								</p>
							</li>
						</ul>
						<Muted>
							The integration path stays reversible: remove the folder and your host
							app reverts to its previous state.
						</Muted>
					</div>
				</div>
			</section>
