				...
				<main className="container flex flex-1 flex-col justify-center gap-8 py-16">
					<div className="space-y-4">
						<H1 className="max-w-2xl">
							Welcome back, {context.profileName}. Manage everything from the menu in
							the top bar.
						</H1>
					...
					<div className="grid gap-4 md:grid-cols-2">
						<div className="rounded-lg border bg-background/70 p-6 text-sm text-muted-foreground">
							<p>
								Signed in as{" "}
								<span className="font-medium">{context.currentSessionUser.id}</span>
								with role{" "}
								<span className="font-medium">{context.currentSessionUser.role}</span>.
							</p>
							<p className="mt-3">
								Review account security and session controls from the menu above.
							</p>
						</div>
						<div className="rounded-lg border bg-background/70 p-6 text-sm text-muted-foreground">
